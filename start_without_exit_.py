        ...
        if inp_choice==1:
            ...
            if ina==1:
                ...
                while True:
                    ...
                    if inc==1:
                        sepal_petal_plot.s_bar_graph()
                        break
                    elif inc==2:
                        sepal_petal_plot.s_pie_chart()
                        break
                ...
                while True:
                    ...
                    inc=int(input("Enter a value:"))
                    if inc==1:
                        sepal_petal_plot.p_bar_graph()
                        break
                    elif inc==2:
                        sepal_petal_plot.p_pie_chart()
                        break
                ...
                while True:
                    ...
                    inc=int(input("Enter a value:"))
                    if inc==1:
                        sepal_petal_plot.sp_bar_graph()
                        break
                    elif inc==2:
                        sepal_petal_plot.sp_pie_chart()
                        break
            elif ina==4:
                break
        elif inp_choice==2:
